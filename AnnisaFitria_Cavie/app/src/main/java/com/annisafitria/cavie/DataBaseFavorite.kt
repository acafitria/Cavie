...
val listfavorite: List<film> = listOf(
    ...
    film(
        ...
        "PEMERAN:\n" +
                "Angga Yunanda, Adhisty Zara, Dannia Salsabilla\n" +
    ...
    film(
        ...
        " SINOPSIS:\n" +
                "   Rara (Jessica Mila) yang terlahir dari rahim seorang model sukses di era 90-an bernama Debby (Karina Suwandi), harus menjalani hidup penuh tekanan perundungan, celaan fisik, dan bias standar kecantikan lantaran memiliki fisik yang berbeda dengan adiknya, Lulu (Yasmin Napper). Rara bertubuh gendut dan berkulit legam warisan gen sang ayah, Hendro (Kiki Narendra), sementara Lulu begitu langsing dan berkulit putih mulus mengikuti gen ibu mereka.\n" +
                "\n" +
        ...
        "PEMERAN:\n" +
                "Jessica Mila, Reza Rahadian, Yasmin Napper, Boy William\n" +
                "Dion Wiyoko, Shareefa Daanish, Clara Bernadeth, \n" +
                 "Karina Nadila, Devina Aureel, Ernest Prakasa\n" +
                "Karina Suwandi, Dewi Irawan, Kiky Saputri\n" +
                "Zsazsa Utari, Aci Resti, Neneng Wulandari\tEndah\n",
        "2019"
    ),
    film(
        R.drawable.bebas,
