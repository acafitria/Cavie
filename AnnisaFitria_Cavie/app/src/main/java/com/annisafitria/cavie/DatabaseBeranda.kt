...
val listfilmberanda: List<film> = listOf(
    film(
        R.drawable.radensaleh,
        "Mencuri Raden Saleh",
        " SINOPSIS:\n" +
                ...
                "\n" +
                "   Aksi pencurian ini tentunya tidak akan berjalan mudah. Apalagi, lukisan itu disimpan di Istana Presiden yang tentunya memiliki sistem keamanan super ketat.",
        "PEMERAN:\n" +
                "Iqbaal Ramadhan, Angga Yunanda, Aghniny Haque\n'"+
                "Rachel Amanda, Umay Shahab, Ari Irham\n",
        "2021",
    ),
    film(
        R.drawable.bebas,
        ...
        "SINOPSIS:\n" +
                ...
                "\n" +
                "   Film ini adalah film pertama Indonesia yang melakukan pengambilan gambar di MRT Jakarta. Sebelum akhirnya diputurkan di MRT Jakarta, Mira sempat berencana melakukan pengambilan gambar di kereta api listrik.",
        "PEMERAN:\n" +
                "Maizura, Marsha Timothy, Sheryl Sheinafia, Susan Bachtiar\n" +
                "Agatha Pricilla, Indy Barends, Lutesha, Salvita Decorte \n" +
                "Zulfa Maharani, Widi Mulia, Baskara Mahendra - Jojo\n" +
                "Baim Wong, Kevin Ardilova, Oka Antara, Brandon Salim\n" +
                "Edward Suhadi, Darius Sinathrya,Joseph Kara - Kepala sekolah\n",
        "2019",

    ),
    film(
        R.drawable.terlalutampan,
        " Terlalu tampan",
        "SINOPSIS:\n" +
    ...
    film(
        ...
        "PEMERAN:\n" +
                "Morgan Oey, Alvaro sebagai Francis Kecil, Mikha Tambayong sebagai Retno Wulandari\n" +
                "Deva Mahenra, Anggika Bölsterli, Millane Fernandez sebagai Inez\n" +
                "Atta Halilintar, Delano Daniel, Ananta Rispo sebagai Hasan",
        "2018",

    ),
    film(
        R.drawable.duagarisbiru,
        "Dua Garis Biru",
        "SINOPSIS:\n" +
                "   Bima dan Dara adalah sepasang kekasih di bangku SMA yang memiliki status akademis dan finansial yang berbeda. Dara memiliki ambisi untuk berkuliah di Korea Selatan karena kesukaannya terhadap K-pop. Suatu hari, mereka berpacaran melebih batas hingga Dara hamil beberapa hari kemudian. Bima menyarankan aborsi, tapi Dara menolak. Bima mencoba mengatakannya kepada orangtuanya, namun tidak mampu. Satu hari di lapangan basket, bolanya mengenai kepala Dara, dan sakitnya menuju perutnya, membuatnya berteriak," +
                " \"Bayi kita gimana?\" Orangtua kedua pihak datang; orangtua Dara diberitahu bahwa Dara dikeluarkan dari sekolah.\n" +
                "\n" +
                "    Dara kemudian diusir dari rumah, memaksanya untuk tinggal di rumah Bima, di mana gosip tentang kehamilannya terdengar. Ketika Dara diizinkan pulang, ia mengetahui rencana orangtuanya untuk memberi bayinya kepada bibi dan pamannya. Mendengar kabar itu, orangtua Bima menyarankan mereka menikah.\n" +
                "\n" +
        ...
        " PEMERAN:" +
                "Zara JKT48, Angga Yunanda, Cut Mini sebagai Yuni (ibu Bima)\n" +
                "Arswendy Bening Swara, Dwi Sasono, Lulu Tobing sebagai Rika (ibu Dara)\n" +
                "Rachel Amanda, Maisha Kanna \n",
        "2020 .",
    ),
    film(
        R.drawable.marposa,
        ...
        "PEMERAN:" +
                "Angga Yunanda, Adhisty, Dannia Salsabilla sebagai Amanda\n" +
                "Abun Sungkar, Junior Roberts, Syakir Daulay \n" +
                "Irgi Ahmad Fahrezi, Ariyo Wahab, Ersa Mayori\n",
        "2020",
    ),
